...
const Lang = Language.getString('log');
    ...
    AlphaX.addCommand({pattern: 'carbon$', fromMe: WType, desc: Lang.CARBON_DESC}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: Config.CAPTION})

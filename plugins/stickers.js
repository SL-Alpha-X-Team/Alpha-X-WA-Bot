...
let WType = Config.WORKTYPE == 'public' ? false : true
    ...
    AlphaX.addCommand({pattern: 'st$', fromMe: WType, desc: Lang.STICKER_DESC}, (async (message, match) => {    
        ...
        if (message.reply_message.video === false && message.reply_message.image) {
            ffmpeg(location)
                ...
                .save('/media/sticker.webp')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('/media/sticker.webp'), MessageType.sticker, {quoted: message.data});
            });
